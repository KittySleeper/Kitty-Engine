...
import kitty.states.menus.options.KeyBindMenu;
import kitty.states.LoadReplayState;
import kitty.states.menus.options.GameplayCustomizeState;
...
class IconColor extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.iconColor = !FlxG.save.data.iconColor;
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.iconColor ? "Match Icon Colors" : "Use Default Colors";
	}
...
class OffsetMenu extends Option
{
	...
	public override function press():Bool
	{
		...
		PlayState.SONG = Song.loadFromJson("Tutorial", "Normal");
